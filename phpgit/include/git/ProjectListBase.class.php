...
abstract class GitPHP_ProjectListBase implements Iterator
{
    ...
    if (isset($projData['charset']) && is_string($projData['charset'])) {
      $projectObj->SetCharset($projData['charset']);
    }else{
      $projectObj->SetCharset(GitPHP_Config::GetInstance()->GetValue('encoding'));
    }
