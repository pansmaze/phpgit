...
class GeSHi {
     ...
     * @var string
     */
    var $code_style = 'font: normal normal 1em/1.1em monospace; margin:0; padding:0; background:none; vertical-align:top;';
     ...
     * @var string
     */
    var $table_linenumber_style = 'width:1px;text-align:right;margin:0;padding:0 2px;vertical-align:top;color:#bdbdbe;background-color:#f5f5f5;';
    ...
    function header() {
        ...
        if ($this->line_numbers != GESHI_NO_LINE_NUMBERS) {
            if ($this->header_type == GESHI_HEADER_PRE) {
                ...
                return "<table$attributes cellpadding='0' cellspacing='0'>$header<tbody><tr class=\"li1\">";
            }
        } else {
            if ($this->header_type == GESHI_HEADER_PRE) {
